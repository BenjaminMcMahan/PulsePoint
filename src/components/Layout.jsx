...
import { LayoutDashboard, List, PlusCircle, GitCompare, TrendingUp, Waves, ScanSearch, GitMerge, LineChart, Menu, X, UserCircle, Grid3x3, Sparkles, Clapperboard, Music, Radio } from "lucide-react";
...
{ path: "/event-correlations", icon: Sparkles, label: "Event Insights" },
{ path: "/video", icon: Clapperboard, label: "Video Sync" },
{ path: "/library", icon: Music, label: "Audio Library" },
{ path: "/sync-player", icon: Radio, label: "Event Sync Player" },
